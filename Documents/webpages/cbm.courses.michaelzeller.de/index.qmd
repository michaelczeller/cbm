...
subtitle: "Learn how to use case-based techniques for research design and systematic inquiry"
details: |
  15123 • Summer 2025<br>Geschwister-Scholl-Institut für Politikwissenschaft (GSI)<br>Ludwig-Maximilians-Universität München
sidebar: false
toc: false
page-layout: full
format:
...
```{r echo=FALSE}
knitr::include_graphics(here::here("files", "img", "cbm-flowchart.png"), error = FALSE)
```
